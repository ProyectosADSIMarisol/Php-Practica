...
<body>
    ...
    <div id="wrapper">
                    ...
                    <div class="col-lg-8">
                        ...
                        <form role="form" id="frmUser" method="post" action="crudUser.php?action=crear">
                            <div class="form-group">
                                <label>Nombres</label>
                                <input id="Nombres" name="Nombres" class="form-control" placeholder="Marisol">
                                <p class="help-block">Nombres completos del usuario.</p>
                            </div>

                            <div class="form-group">
                                <label>Apellidos</label>
                                <input id="Apellidos" name="Apellidos" class="form-control" placeholder="Daza Bautista">
                            ...
                            <div class="form-group">
                                <label>Foto</label>
                                <input id="Foto" name="Foto" class="form-control" placeholder="Foto tuya">
                                <p class="help-block">Foto que desees.</p>
                            </div>

     <div class="form-group">
                                <label>Web personal</label>
                                <input id="Webpersonal" name="Webpersonal" class="form-control" placeholder="www.marydazita@.com">
     ...
     <div class="form-group">
                                <label>Email</label>
                                <input id="Email" name="Email" class="form-control" placeholder="marydazita@gmail.com">
                                <p class="help-block">Email Personal.</p>
                            </div>
