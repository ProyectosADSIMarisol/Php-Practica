                    ...
                    <div class="col-lg-8">
                        ...
                        <form role="form" id="frmUser" method="post" action="crudUser.php?action=crear">
                            <div class="form-group">
                                <label>Nombres</label>
                                <input id="nombres" name="nombres" class="form-control" placeholder="Marisol " required>
                                <p class="help-block">Nombres del usuario</p>
                            </div>

                            <div class="form-group">
                                <label>Apellidos</label>
                                <input id="apellidos" name="apellidos" class="form-control" placeholder="Daza" required>
                                <p class="help-block">Apellidos del usuario</p>
                            </div>

                            <div class="form-group">
                                <label>Direccion</label>
                                <input id="direccion" name="direccion" class="form-control" placeholder=" Cra  12 #23-23" required>
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label>Email</label>
                                <input id="email" name="email" class="form-control" placeholder="dazabautisamary@gmail.com" type="email" required>
                                <p class="help-block">Correo electronico del usuario</p>
                            </div>

                            <div class="form-group">
                                <label>Usuario</label>
                                <input id="usuario" name="usuario" class="form-control" placeholder="mary1234" required>
